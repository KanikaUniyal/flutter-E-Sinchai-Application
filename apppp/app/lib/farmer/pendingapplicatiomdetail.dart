...
class PendingDetailPage extends StatefulWidget {
  ...
  const PendingDetailPage({Key? key, required this.farmer}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<PendingDetailPage> {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text('Application Status'.tr,style: TextStyle(color: Colors.black),),
                      ),
                    ),
