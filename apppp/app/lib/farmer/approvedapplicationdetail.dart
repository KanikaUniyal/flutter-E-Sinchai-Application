...
class ApprovedDetailPage extends StatefulWidget {
  final farmerrr farmer;

  const ApprovedDetailPage({Key? key, required this.farmer}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<ApprovedDetailPage> {
