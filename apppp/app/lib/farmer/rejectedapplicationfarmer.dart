...
import 'package:app/farmer/rejectedapplicationdetail.dart';
...
class farmerrrs {
  ...
  factory farmerrrs.fromJson(Map<String, dynamic> json) {
    return farmerrrs(
      id: json['id'] ?? "",
...
class _MyAppState extends State<MApp> {
  ...
  late List<farmerrrs> farmers;
  late List<farmerrrs> filteredFarmers = [];
  TextEditingController searchController = TextEditingController();

  Future<List<farmerrrs>> fetchData(String status) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // }// Return empty list
          ...
          if (data.isNotEmpty) {
            return data.map((json) => farmerrrs.fromJson(json)).toList();
          } else {
            Fluttertoast.showToast(
              msg: 'No data found.',
              toastLength: Toast.LENGTH_SHORT,
  ...
  //   // Update the UI with the fetched userName and userType
  //   setState(() {});
  // }
  @override
                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Rejected Applications',
                                        ...
                                        Container(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () {
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(builder: (context) => RejectedDetailPage(farmer: farmer)),
                                              );
                                              // Handle button tap
                                            },
                                            style:
