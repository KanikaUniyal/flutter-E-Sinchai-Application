...
import 'package:app/farmer/approvedapplicationdetail.dart';
...
class farmerrr {
  ...
  factory farmerrr.fromJson(Map<String, dynamic> json) {
    return farmerrr(
      id: json['id'] ?? "",
...
class _MyAppState extends State<MAp> {
  ...
  //     "f8329dce150599ba7ae97b4f053693cb9464d2723bb620ab38457c458eb8f8b2";
  ...
  String userType = '';
  late List<farmerrr> farmers;
  late List<farmerrr> filteredFarmers = [];
  ...
  Future<List<farmerrr>> fetchData(String status) async {
    try {
      ...
      if (response.statusCode == 200) {
       ...
       // final List<dynamic> data = json.decode(response.body)['data'];
        if (jsonData['error']  ){
          ...
          if (data.isNotEmpty) {
            return data.map((json) => farmerrr.fromJson(json)).toList();
          } else {
            Fluttertoast.showToast(
              msg: 'No data found.',
              toastLength: Toast.LENGTH_SHORT,
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Approved Applications',
                                  ...
                                  Container(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => ApprovedDetailPage(farmer: farmer)),
                                        );
                                        // Handle button tap
                                      },
                                      style:
                                      getStatusButtonStyle(farmer.status),
                                      child: Text('VIEW STATUS'), // Empty button text
                                    ),
                                  ),
                                  SizedBox(height: 0.0),
                                ],
