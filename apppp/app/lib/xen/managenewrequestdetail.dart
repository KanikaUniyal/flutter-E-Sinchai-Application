...
class managedetailspage extends StatefulWidget {
  ...
  const managedetailspage({Key? key, required this.farmer}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<managedetailspage> {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text('Request ID:${widget.farmer.id}',style: TextStyle(fontSize: 14),),
                            SizedBox(width: 1), // Add horizontal space
                            Text('Request Date:${widget.farmer.created_date}',style: TextStyle(fontSize: 13),),
                          ],
                        ),
