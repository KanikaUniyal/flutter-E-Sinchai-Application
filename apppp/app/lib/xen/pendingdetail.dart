...
import 'pending.dart';
class penddetailspage extends StatefulWidget {
  final Farmers farmer;

  const penddetailspage({Key? key, required this.farmer}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<penddetailspage> {
                      ...
                      children: [
                        ...
                        Row( // Adjusted this section to add space between Outlet and Patwari Name
                          children: [
                            ...
                            SizedBox(width: 20),
                            Text('Farmer Name: ${widget.farmer.full_name}'),
