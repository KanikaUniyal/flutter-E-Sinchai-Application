...
//   final Farmofficial farmer;
//
//   const Viewdetailspage({Key? key, required this.farmer}) : super(key: key);
//
//   @override
//   _DetailPageState createState() => _DetailPageState();
// }
//
// class _DetailPageState extends State<Viewdetailspage> {
...
//                             Text('Request Date: ${widget.farmer.createdDate}'),
//                           ],
//                         ),
//
//                         Text('Application Type: ${widget.farmer.applicationType}'),
...
//                             Text('Patwari Name: ${widget.farmer.patwariName}'),
//                           ],
//                         ),
//                         Row( // Adjusted this section to add space between Outlet and Patwari Name
//                           children: [
...
//                             SizedBox(width: 20),
//                             Text('Water Channel: ${widget.farmer.waterChannel} '),
//                           ],
//                         ),
//                         Row( // Adjusted this section to add space between Outlet and Patwari Name
//                           children: [
