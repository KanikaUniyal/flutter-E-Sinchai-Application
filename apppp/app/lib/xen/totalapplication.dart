...
import 'totalapplicationdetails.dart';
...
class Farmerrl {
  ...
  factory Farmerrl.fromJson(Map<String, dynamic> json) {
...
class _MyAppState extends State<MyAppp>  {
  ...
  late List<Farmerrl> farmers;
  late List<Farmerrl> filteredFarmers = [];
  ...
  Future<List<Farmerrl>> fetchData(String status) async {
    try {
      ...
      //  final List<dynamic> data = json.decode(response.body)['data'];
        ...
        if (data.isNotEmpty) {
          return data.map((json) => Farmerrl.fromJson(json)).toList();
        }
        else {
                                   ...
                                   width: double.infinity,
                                      child: ElevatedButton(
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => xendetailspage(farmer:farmer)),
                                          );
                                          // Handle button tap
                                        },
                                        style:
