...
class approdetailspage extends StatefulWidget {
  final Farmerss farmer;

  const approdetailspage({Key? key, required this.farmer}) : super(key: key);

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<approdetailspage> {
